...
export const FALLBACK_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "A production-grade n8n automation workflow that listens to incoming support tickets, routes them via an LLM classifier, enriches CRM leads using Clearbit APIs, and posts auto-generated draft replies to Slack and Zendesk.",
  ...
  },
  {
    ...
    description: "A stateful multi-agent system built using LangGraph to perform web research, synthesize information, draft reports, and self-correct based on human-in-the-loop validation or automated reflection steps.",
  ...
  },
  {
    ...
    description: "An autonomous agent team composed of a Product Manager Agent, a Senior Developer Agent, and a QA Tester Agent cooperating via CrewAI. Generates complete, lint-checked web components from user stories.",
  ...
  },
  {
    ...
    description: "High-performance inference engine hosting fine-tuned Llama-3 models. Features dynamic batching, paged attention, and FP8 quantization for real-time customer-facing applications.",
