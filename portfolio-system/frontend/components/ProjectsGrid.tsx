      ...
      <div className="max-w-6xl w-full mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
            Core Engineering <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-indigo-400">Projects</span>
          </h2>
          ...
          <p className="text-zinc-400 mt-4 max-w-xl mx-auto text-sm md:text-base">
            Demonstrating robust code design, advanced neural frameworks, and production security integrations.
          </p>
        </div>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex-1 p-5 flex flex-col justify-between space-y-4">
                ...
                {/* Business Impact and Target Button */}
                <div className="space-y-4 pt-2">
                  ...
                  {/* Repository Target Button */}
                  <a
                    href={project.repo_url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center space-x-2 py-2 px-4 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800/80 text-zinc-300 hover:text-white text-xs font-semibold transition-all duration-300"
                  >
